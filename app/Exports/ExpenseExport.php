...
class ExpenseExport implements FromQuery,WithHeadings,WithMapping
{
    ...
    public function query()
    {
        ...
        if(isset($user->membership_code)){
            return Expense::where('membership_id',$user->membership_code)->whereBetween('created_at', [$startDate, $endDate]);
        }else{
            return Expense::where('membership_id',$user->member_by)->whereBetween('created_at', [$startDate, $endDate]);
        }
    }
